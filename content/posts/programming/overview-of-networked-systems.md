...
The way of connection of nodes in a network called _topology_. Its could be simple connection between two nodes to complexs layouts of nodes.
...
4\. Application layer -- includes the protocols used by most applications for providing user services or exchanging application data over the network conneciton established by the lowe r lever protocols.